...
static void radix (ushort byte, ushort keyloc, ushort member_size,
                   unsigned long members, void *source, void *dest)
{
/* local variables */
/* count will be an accumulation array (serving as an index for each list) */
unsigned long count[256];

unsigned long   sum, /* sum for summing elements into the accumulation buffer */
 ...
 *                                                                     *
 ***********************************************************************/
void radix_sort (ushort keylen, ushort keyloc, ushort m_size, unsigned long members, void *to_sort)
{
/* local variables */
