The benchmarks under this directory are ported from the HMPP benchmarks of the
PolyBench/GPU suite with permissions from the authors.  As part of the
OpenDwarfs they are made available under the LGPL as with the rest of the suite.
