...
struct dpResults semiGappedScoring_dpBeforeSeedGPU(unsigned char* subject, struct PSSMatrixFP PSSMatrixFP,
...
struct dpResults semiGappedScoring_dpAfterSeedGPU(unsigned char* subject, struct PSSMatrixFP PSSMatrixFP,
                              int4 dropoff, int4 subjectLength, int4 *bestRow, int4 *insertQrow,
							  unsigned char encoding_numCodes, int4 openGapPenalty, int4 extensionGapPenalty,
							  int4 semiGappedExtensionN);

semiGappedScoring_scoreGPU(struct ungappedExtension *ungappedExtension,
...
void alignments_pruneRegion(struct ungappedExtension *ungappedExtension, 
...
__kernel void semiGappedScoring_kernel(struct sequenceDataFP 	*sequenceDataFP, 
